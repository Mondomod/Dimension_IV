...
#ifndef _HEAVY_DIMENSION_IV_H_
#define _HEAVY_DIMENSION_IV_H_
...
typedef enum {
  HV_DIMENSION_IV_PARAM_IN_ANTIPHASE = 0x899A1AC4, // antiphase
  HV_DIMENSION_IV_PARAM_IN_DIMENSION = 0x4612B591, // dimension
} Hv_Dimension_IV_ParameterIn;
 ...
 */
HeavyContextInterface *hv_Dimension_IV_new(double sampleRate);
 ...
 */
HeavyContextInterface *hv_Dimension_IV_new_with_options(double sampleRate, int poolKb, int inQueueKb, int outQueueKb);

/**
 * Free the patch instance.
 */
void hv_Dimension_IV_free(HeavyContextInterface *instance);
